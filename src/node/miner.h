...
private:
    ...
    std::unordered_set<uint256, SaltedTxidHasher> m_commit_models_in_block;
    std::unordered_set<uint256, SaltedTxidHasher> m_challenge_models_in_block;
...
private:
    ...
    */
    ...
    /** Ensure model commit transactions have already passed API validation */
    bool PackageHasApiValidatedCommits(const CTxMemPool::setEntries& package) const;
};
...
// Runtime override for mining model identifier
