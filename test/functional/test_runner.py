...
EXTENDED_SCRIPTS = [
    ...
    # TensorCash asset tests (added)
    'rpc_assets.py',
    # Additional TensorCash asset/policy tests (ensure discovery, run via --extended)
]
...
BASE_SCRIPTS = [
    ...
    'feature_asset_policy_mindust.py',
    'feature_asset_policy_multitouch_fee.py',
    'feature_assets_outext_flow.py',
    'feature_assets_unknown_tlv.py',
    'feature_asset_policy_anyonecanpay.py',
    'feature_fairsign_adaptor.py',
    'feature_assets_bond_lock_unlock.py',
    'feature_assets_burn_lock.py',
    'feature_assets_coin_swap.py',
    'feature_assets_multiparty_swap.py',
    'feature_assets_network_partition.py',
    'feature_assets_deep_reorg.py',
    'feature_assets_ticker.py',
    ...
    'feature_covenant_repowallet.py',
    'feature_covenant_vault_regression.py',
    'feature_covenant_fwdoption.py',
    'feature_covenant_spot.py',
    'feature_icu_acceptance.py',
    'feature_icu_acceptance_record.py',
    'feature_icu_acceptance_record_create.py',
    'feature_icu_context.py',
    'feature_icu_context_builder.py',
    'feature_icu_context_acceptance.py',
    'feature_covenant_repo_exchange.py',
    'feature_pricing_rpc.py',
    'feature_assets_zk_basic.py',
    'feature_assets_zk_reorg.py',
    'feature_assets_vk_lifecycle.py',
    'feature_assets_kyc_delegation.py',
    'feature_assets_tfr_binding.py',
    'feature_assets_robustness.py',
    'feature_asset_zk_validation.py',
    'p2p_vdf_spv_headers.py',
    'feature_retarget_nbits.py',
    'feature_vdf_spv_presync.py',
    ...
    'feature_reorg_advisory.py',
    'feature_reorg_gating.py',
    'feature_header_flags_two_nodes.py',
    'feature_tick_accumulator.py',
    'p2p_vdf_spv_reorg.py',
    'feature_header_flags.py',
    'rpc_psbt.py',
    ...
    'wallet_basic.py',
    'wallet_bip322.py',
    'wallet_asset_fundraw_psbt.py',
    'wallet_asset_coin_selection.py',
    'wallet_asset_spend_errors.py',
    'wallet_psbt_asset_roundtrip.py',
    ...
    'wallet_pq_mldsa.py',
    'wallet_pq_psbt.py',
    'wallet_pq_psbt_advanced.py',
    'wallet_pq_psbt_edge_cases.py',
    'feature_bip68_sequence.py',
    'rpc_packages.py',
    'rpc_bind.py --ipv4',
    'rpc_bind.py --ipv6',
    'rpc_bind.py --nonloopback',
    'p2p_vdf_spv_tip_preference.py',
    'p2p_vdf_spv_massive_tick_ban.py',
    'p2p_vdf_spv_ext_liveness.py',
    'p2p_vdf_spv_rate_limits.py',
    'p2p_vdf_spv_asn_corroboration.py',
    'p2p_feefilter.py',
    ...
    'feature_broker_mining_peer_build_ahead.py',
    ...
    'feature_dersig.py',
    'feature_cltv.py',
    'feature_difficulty_derivative_wallet.py',
    'feature_difficulty_option_wallet.py',
    'feature_difficulty_coop_close.py',
    'feature_difficulty_wizard_smoke.py',
    'feature_difficulty_atomic_open.py',
    'feature_difficulty_atomic_open_option.py',
    'feature_option_tokenization.py',
    'feature_difficulty_pricing.py',
    'rpc_uptime.py',
    'feature_discover.py',
...
def _dedupe_scripts(script_list):
    seen = set()
    deduped = []
...
ALL_SCRIPTS = _dedupe_scripts(EXTENDED_SCRIPTS + BASE_SCRIPTS)
...
def main():
    ...
    elif args.extended or os.environ.get('FULL_TESTS'):
